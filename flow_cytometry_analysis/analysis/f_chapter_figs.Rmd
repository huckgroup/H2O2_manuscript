...
textsize_small <- theme(text = element_text(size = 8.5, family = "sans", colour = "black"), 
...
fig1_panelB <- ggplot(data_DS095_fig1B, aes(x = fluorescence)) +
  ...
  theme_bw() +
  textsize_small + 
  theme(legend.position = "none", panel.grid.minor = element_blank(), strip.text.x = element_text(size = 6.5, margin = margin(0.1, 0, 0.1, 0, "cm")))
...
fig1_panelC <- ggplot(avg_DS095_fig1C, 
  ...
  theme_bw() +
  textsize_small +
  theme(panel.grid.minor = element_blank(), strip.text.x = element_text(size = 6, margin = margin(0.1, 0, 0.1, 0, "cm")), axis.text = element_text(size = 6.5), legend.key.height = unit(0.3, "cm"), legend.spacing.y = unit(0.1, "cm"), legend.box.spacing = unit(0.05, "cm")) +
...
ggsave(
  fig1,
  filename = "output/figures/chapter_figs/fig1_main.pdf",
  width = 6,
  height = 3,
  units = "in",
  dpi = 300
...
ggsave(
  fig1,
  filename = "output/figures/chapter_figs/fig1_main.jpg",
  width = 6,
  height = 3,
  units = "in",
  dpi = 300
...
ggsave(
  fig1,
  filename = "output/figures/chapter_figs/fig1_main.png",
  width = 6,
  height = 3,
  units = "in",
  dpi = 300
...
```{r fig2_alt_panelA, fig.retina=1}
# Select data
avg_DS095_fig2A <- avg_DS095 %>%
  subset(staining == "yes" & protein %in% proteins_fig2A & time_point == "10 min" & H2O2_conc_mM != 0)

# Figure
fig2_alt_panelA <- ggplot(avg_DS095_fig2A,
       aes(
         x = H2O2_conc_mM,
         y = percent_on, 
         group = protein,
  ...
  coord_cartesian(ylim = c(0, 100), xlim = c(1e-1, 1e2)) +
...
png_model_percent <- image_read("output/figures/non_R_figs/DRcurve_model_percon_MW_v4.png") %>%
  image_ggplot()
png_model_percent
```
...
```{r fig2_main, fig.width=6, fig.height=4.5, fig.retina=1}
# Combine all panels of the figure
fig2_AB <- plot_grid(fig2_alt_panelA_full, png_DR_vis, labels = PANEL_labels[1:2], ncol = 2, rel_widths = c(1.2, 1), label_size = 10)
fig2_CD <- plot_grid(png_model, png_model_percent, labels = PANEL_labels[3:4], ncol = 2, rel_widths = c(1, 1.1), label_size = 10)
fig2 <- plot_grid(fig2_AB, fig2_CD, ncol = 1, rel_heights = c(1.2, 1))
...
ggsave(
  fig2,
  filename = "output/figures/chapter_figs/fig2_main.pdf",
  width = 6,
  height = 4.5,
  units = "in",
  dpi = 300
...
ggsave(
  fig2,
  filename = "output/figures/chapter_figs/fig2_main.jpg",
  width = 6,
  height = 4.5,
  units = "in",
  dpi = 300
...
ggsave(
  fig2,
  filename = "output/figures/chapter_figs/fig2_main.png",
  width = 6,
  height = 4.5,
  units = "in",
  dpi = 300
...
medians_DS096_fig3B <- medians_DS096 %>%
  select(expID, stim_description, time_min, conc_at_time_mM) %>%
  distinct() %>%
  add_row(expID = "DS096", stim_description = "H2O2 step (10 mM)", time_min = 0, conc_at_time_mM = 10)
...
fig3_panelB <- ggplot(medians_DS096_fig3B) +
  ...
  geom_line(aes(x = time_min, y = conc_at_time_mM, group = stim_description, color = stim_description), linewidth = 0.75) +
  geom_point(aes(x = time_min, y = conc_at_time_mM, group = stim_description, color = stim_description), size = 1) +
  geom_text(aes(75, 10), label = expression("H"[2]*"O"[2]*" step"), color = "black", size = 1.75, show.legend = F, hjust = 1, vjust = -0.5) +
  geom_text(aes(75, 0), label = "PBS step", color = "black", size = 1.75, show.legend = F, hjust = 1, vjust = -0.8) +
  geom_text(aes(20, 10), label = "20 min", color = "black", size = 1.75, show.legend = F, hjust = 1.5, vjust = 1.6) +
  geom_text(aes(60, 10), label = "60 min linear", color = "black", size = 1.75, show.legend = F, hjust = 1.5, vjust = 1.6) +
  geom_text(aes(60, 10), label = "60 min\nexponential", color = "black", size = 1.75, show.legend = F, hjust = -0.08, vjust = 1.2) +
  scale_x_continuous(
    limits = c(0, 75),
    breaks = c(0, 20, 60),
  ) +
  ...
  facet_wrap(vars(factor(expID, labels = "Input patterns"))) +
  labs(x = "Time (min)", y = expression("H"[2]*"O"[2]*" dose (mM)")) + 
  theme_bw() +
  textsize_small +
  theme(panel.grid = element_blank(), strip.text.x = element_text(margin = margin(0.1, 0, 0.1, 0, "cm")), legend.position = "none")
...
fig3_panelC <- ggplot() +
  ...
  scale_color_manual(values = colors_profiles) +
  coord_cartesian(ylim = c(0, 100)) +
  facet_wrap(vars(factor(expID, labels = "Time"))) + #, labels = "Input patterns"
  labs(x = "Time (min)", y = "% cells ON") +
  theme_bw() +
  theme(legend.position = "none", panel.grid.minor = element_blank(), panel.grid.major.x = element_blank(), strip.text.x = element_text(margin = margin(0.1, 0, 0.1, 0, "cm")), plot.margin = unit(c(0.1, 0.35, 0.1, 0.1), "cm")) +
  textsize_small
fig3_panelC
```
...
fig3_panelD <- ggplot(subset(medians_DS096_fig3CDE, stim_profile == "gradient"),
  ...
  scale_x_continuous(
    ...
    labels = c("0 (0%)", "2.5 (25%)", "5 (50%)", "7.5 (75%)", "10 (100%)")
  ) +
  coord_cartesian(ylim = c(0, 100)) +
  facet_wrap(vars(factor(expID, labels = "Dose reached during gradient"))) + #, labels = "Input patterns"
  labs(x = expression("H"[2]*"O"[2]*" dose (mM) (% of gradient)"), y = "% cells ON") +
  theme_bw() +
  theme(legend.position = "none", panel.grid.minor = element_blank(), strip.text.x = element_text(margin = margin(0.1, 0, 0.1, 0, "cm")), plot.margin = unit(c(0.1, 0.35, 0.1, 0.1), "cm")) +
  textsize_small
fig3_panelD
```
...
fig3_panelE <- ggplot(subset(medians_DS096_fig3CDE, stim_profile == "gradient"), 
  ...
  scale_color_manual(values = colors_profiles) +
  coord_cartesian(ylim = c(0, 100)) +
  facet_wrap(vars(factor(expID, labels = "Cumulative exposure"))) + #, labels = "Input patterns"
  labs(x = expression("Exposure: AUC of input dose vs time (log"[10]*")"), y = "% cells ON") +
  theme_bw() +
  theme(legend.position = "none", panel.grid.minor = element_blank(), strip.text.x = element_text(margin = margin(0.1, 0, 0.1, 0, "cm")), plot.margin = unit(c(0.1, 0.35, 0.1, 0.1), "cm")) +
  textsize_small
fig3_panelE
...
```{r fig3_main, fig.width=6, fig.height=4.5, fig.retina=1}
# Combine all panels of the figure
...
fig3 <- plot_grid(fig3_AB, fig3_CDE, ncol = 2, rel_widths = c(1.1, 1))
...
ggsave(
  fig3,
  filename = "output/figures/chapter_figs/fig3_main.pdf",
  width = 6,
  height = 4.5,
  units = "in",
  dpi = 300
...
ggsave(
  fig3,
  filename = "output/figures/chapter_figs/fig3_main.jpg",
  width = 6,
  height = 4.5,
  units = "in",
  dpi = 300
...
ggsave(
  fig3,
  filename = "output/figures/chapter_figs/fig3_main.png",
  width = 6,
  height = 4.5,
  units = "in",
  dpi = 300
...
data_text_fig4B_single <- medians_combi %>%
  subset(stim_profile == "gradient" & expID == "DS085" & stim_description != "60 min quadratic gradient (10 mM)") %>%
  select(expID, stim_description, stim_descrip_short, gradient_duration, conc_final) %>%
  distinct() %>%
  mutate(conc_final_nr = as.numeric(gsub("(.*) mM", "\\1", conc_final))) %>%
  arrange(expID, gradient_duration, conc_final_nr) %>%
...
# Figure
fig4_panelB_single <- ggplot(subset(medians_combi_fig4B, expID == "DS085")) +
  geom_vline(xintercept = 20, size = 0.5, linetype = "dashed") +
  geom_vline(xintercept = 60, size = 0.5, linetype = "dotdash") +
  geom_line(aes(x = time_min, y = conc_at_time_mM, group = stim_descrip_short, color = stim_description), size = 0.75) +
  geom_text(data = data_text_fig4B_single,
            mapping = aes(x = gradient_duration, y = conc_final_nr, label = label),
            color = "black", size = 3, show.legend = F, hjust = 2, vjust = 1.5) +
  facet_wrap(vars(factor(expID, labels = c("Medium (5 mM)")))) + 
  scale_x_continuous(
    limits = c(0, 60),
    breaks = c(0, 20, 60),
  ) +
  scale_y_continuous(breaks = c(0, 1.25, 2.5, 3.75, 5), labels = c("0", "1.25", "2.5", "3.75", "5")) + 
  scale_color_manual(
  ...
  theme_bw() +
  textsize_small +
  theme(panel.grid.minor = element_blank(), panel.grid.major.x = element_blank(), legend.position = "none", legend.justification = "right", strip.text.x = element_text(margin = margin(0.1, 0, 0.1, 0, "cm")))
fig4_panelB_single
```
...
Table with gradient rates and EC50% CD79a, SYK, and PLCy2
...
kable(data_fig4_all) %>% kable_styling(bootstrap_options = c("striped", "hover"))
kable(data_fig4_sens) %>% kable_styling(bootstrap_options = c("striped", "hover"))
...
png_rate_table <- image_read("output/figures/non_R_figs/rate_sensitivity_table_v2.png") %>%
  image_ggplot()
png_rate_table
```
...
proteins_labels_fig4D <- c("pCD79a\n(Y182)", "pSYK\n(Y525/Y526)", "pPLCy2\n(Y759)")

fig4_panelD_sens <- ggplot(data_fig4_sens) +
  geom_col(aes(
    x = protein,
    y = sensitivity_mean, 
    group = protein,
  ...
  scale_x_discrete(labels = proteins_labels_fig4D) +
  labs(x = "", y = "Rate sensitivity\n(EC50% change per mM/min rate change)") +
  theme_bw() +
  textsize_small +
...
```{r fig4_main, fig.width=6, fig.height=5.5, fig.retina=1}
fig4_AD <- plot_grid(png_rate_EC50, fig4_panelD_sens, labels = PANEL_labels[c(1, 4)], ncol = 2, rel_widths = c(1.5, 1), label_size = 10)
fig4_BC <- plot_grid(fig4_panelB_single, png_rate_table, labels = c(PANEL_labels[2:3]), ncol = 2, rel_widths = c(1, 1), label_size = 10, align = "h", axis = "blr", scale = c(1, 0.95))
fig4_v6 <- plot_grid(fig4_AD, fig4_BC, ncol = 1, rel_heights = c(1.2, 1), label_size = 10)
...
ggsave(
  fig4_v6,
  filename = "output/figures/chapter_figs/fig4_main.pdf",
  width = 5,
  height = 4.5,
  units = "in",
  dpi = 300
...
ggsave(
  fig4_v6,
  filename = "output/figures/chapter_figs/fig4_main.jpg",
  width = 6,
  height = 5.5,
  units = "in",
  dpi = 300
...
ggsave(
  fig4_v6,
  filename = "output/figures/chapter_figs/fig4_main.png",
  width = 5,
  height = 4.5,
  units = "in",
  dpi = 300
...
```{r supp_fig1_ridge_step,fig.width=6, fig.height=7, fig.retina=1}
...
suppfig1_panelA <- ggplot(data_suppfig1A, aes(x = fluorescence)) +
  ...
  geom_vline(data = thresholds_suppfig1A, aes(xintercept = threshold), linewidth = 0.5) +
  facet_wrap(vars(factor(H2O2_conc_mM, labels = conc_suppfig1)), ncol = 1) +
  scale_x_log10(
    breaks = trans_breaks("log10", function(x) 10^x),
    labels = trans_format("log10", math_format(10^.x))) +
  scale_fill_manual(values = colors_blue9[2:8]) +
  labs(x = "Fluorescent intensity\npCD79a (Y182)", y = "Time (min)") +
  theme_bw() +
  textsize_small +
  theme(legend.position = "none", text = element_text(size = 7), strip.text.x = element_text(size = 6.5, margin = margin(0.1, 0, 0.1, 0, "cm")))
# suppfig1_panelA
...
suppfig1_panelB <- ggplot(data_suppfig1B, aes(x = fluorescence)) +
  ...
  geom_vline(data = thresholds_suppfig1B, aes(xintercept = threshold), linewidth = 0.5) +
  facet_wrap(vars(factor(H2O2_conc_mM, labels = conc_suppfig1)), ncol = 1) +
  scale_x_log10(
    breaks = trans_breaks("log10", function(x) 10^x),
    labels = trans_format("log10", math_format(10^.x))) +
  scale_fill_manual(values = colors_blue9[2:8]) +
  labs(x = "Fluorescent intensity\npSYK (Y525/Y526)", y = "Time (min)") +
  theme_bw() +
  textsize_small +
  theme(legend.position = "none", text = element_text(size = 7), strip.text.x = element_text(size = 6.5, margin = margin(0.1, 0, 0.1, 0, "cm")))
# suppfig1_panelB
...
suppfig1_panelC <- ggplot(data_suppfig1C, aes(x = fluorescence)) +
  ...
  geom_vline(data = thresholds_suppfig1C, aes(xintercept = threshold), linewidth = 0.5) +
  facet_wrap(vars(factor(H2O2_conc_mM, labels = conc_suppfig1)), ncol = 1) +
  scale_x_log10(
    breaks = trans_breaks("log10", function(x) 10^x),
    labels = trans_format("log10", math_format(10^.x))) +
  scale_fill_manual(values = colors_blue9[2:8]) +
  labs(x = "Fluorescent intensity\npPLCy2 (Y759)", y = "Time (min)") +
  theme_bw() +
  textsize_small +
  theme(legend.position = "none", text = element_text(size = 7), strip.text.x = element_text(size = 6.5, margin = margin(0.1, 0, 0.1, 0, "cm")))
# suppfig1_panelC
...
# Combine all panels of the figure
suppfig1 <- plot_grid(suppfig1_panelA, suppfig1_panelB, suppfig1_panelC, labels = PANEL_labels[1:3], ncol = 3, rel_widths = c(1, 1, 1), label_size = 10)
...
ggsave(
  suppfig1,
  filename = "output/figures/chapter_figs/suppfig1_ridge_step.pdf",
  width = 6,
  height = 5,
  units = "in",
  dpi = 300
...
ggsave(
  suppfig1,
  filename = "output/figures/chapter_figs/suppfig1_ridge_step.jpg",
  width = 6,
  height = 7,
  units = "in",
  dpi = 300
...
ggsave(
  suppfig1,
  filename = "output/figures/chapter_figs/suppfig1_ridge_step.png",
  width = 6,
  height = 5,
  units = "in",
  dpi = 300
...
ggsave(
  suppfig2,
  filename = "output/figures/chapter_figs/suppfig2_data_variability_placeholder.jpg",
  width = 4,
  height = 4,
  units = "in",
  dpi = 300
...
```{r supp_fig3_model_variability, fig.width=6, fig.height=3, fig.retina=1}
suppfig3 <- ggplot() +
  geom_blank() +
  scale_x_continuous(limits = c(0, 10)) + 
  scale_y_continuous(limits = c(0, 10)) + 
...
ggsave(
  suppfig3,
  filename = "output/figures/chapter_figs/suppfig3_model_variability_placeholder.jpg",
  width = 6,
  height = 3,
  units = "in",
  dpi = 300
...
```
***Figure S3: Cell-to-cell variability in the model.** *


### Suppl fig S4

```{r supp_fig4_model_DR,fig.width=4.5, fig.height=4, fig.retina=1}
suppfig4_place <- ggplot() +
  geom_blank() +
  scale_x_continuous(limits = c(0, 10)) + 
  scale_y_continuous(limits = c(0, 10)) + 
  labs(title = "Simulated DR curves from the model") + 
...
# suppfig4 <- plot_grid(png_model_MFI, png_model_percent, labels = panel_labels[c(1, 2)], ncol = 2, rel_widths = c(1, 1))
# suppfig4

# Save figure as jpg
ggsave(
  suppfig4_place,
  filename = "output/figures/chapter_figs/suppfig4_model_DR_placeholder.jpg",
  width = 4.5,
  height = 4,
  units = "in",
  dpi = 300
...
gc()
```
***Figure S4: Simulated dose-response curves.** *
...
suppfig5_panelA <- ggplot(data_suppfig5A, aes(x = fluorescence)) +
  ...
  facet_wrap(vars(factor(stim_description, levels = inputs_suppfig5, labels = input_names_suppfig5)), ncol = 1, scales = "free_y") +
  scale_x_log10(
    breaks = trans_breaks("log10", function(x) 10^x),
    labels = trans_format("log10", math_format(10^.x))) +
  ...
  theme_bw() +
  textsize_small +
  theme(legend.position = "none", strip.text.x = element_text(size = 6.5, margin = margin(0.1, 0, 0.1, 0, "cm")))
# suppfig5_panelA
...
# Combine all panels of the figure
suppfig5 <- plot_grid(suppfig5_panelA, suppfig5_panelB, suppfig5_panelC, labels = PANEL_labels[1:3], ncol = 3, rel_widths = c(1, 1, 1), label_size = 10)
...
ggsave(
  suppfig5,
  filename = "output/figures/chapter_figs/suppfig5_ridge_gradient.pdf",
  width = 6,
  height = 6,
  units = "in",
  dpi = 300
...
ggsave(
  suppfig5,
  filename = "output/figures/chapter_figs/suppfig5_ridge_gradient.jpg",
  width = 6,
  height = 6,
  units = "in",
  dpi = 300
...
ggsave(
  suppfig5,
  filename = "output/figures/chapter_figs/suppfig5_ridge_gradient.png",
  width = 6,
  height = 6,
  units = "in",
  dpi = 300
...
suppfig6_A <- ggplot() +
  ...
  scale_color_manual(values = colors_profiles) +
  coord_cartesian(ylim = c(0, 100)) +
  facet_wrap(vars(factor(protein), factor(expID, labels = "Time"))) + #, labels = "Input patterns"
  labs(x = "Time (min)", y = "% cells ON") +
  theme_bw() +
  theme(legend.position = "none", panel.grid.minor = element_blank(), panel.grid.major.x = element_blank(), strip.text.x = element_text(margin = margin(0.1, 0, 0.1, 0, "cm")), plot.margin = unit(c(0.1, 0.35, 0.1, 0.1), "cm")) +
  textsize_small
...
suppfig6_C <- ggplot() +
  ...
  labs(x = expression("Exposure: AUC of input dose vs time (log"[10]*")"), y = "% cells ON") +
  theme_bw() +
  theme(legend.position = "bottom", panel.grid.minor = element_blank(), strip.text.x = element_text(margin = margin(0.1, 0, 0.1, 0, "cm")), plot.margin = unit(c(0.1, 0.35, 0.1, 0.1), "cm")) +
...
ggsave(
  suppfig6,
  filename = "output/figures/chapter_figs/suppfig6_line_gradient.pdf",
  width = 6,
  height = 6,
  units = "in",
  dpi = 300
...
ggsave(
  suppfig6,
  filename = "output/figures/chapter_figs/suppfig6_line_gradient.jpg",
  width = 6,
  height = 6,
  units = "in",
  dpi = 300
...
ggsave(
  suppfig6,
  filename = "output/figures/chapter_figs/suppfig6_line_gradient.png",
  width = 6,
  height = 6,
  units = "in",
  dpi = 300
...
png_model_grad <- image_read("output/figures/non_R_figs/Model_gradients_percon_MW_v4.png") %>%
  image_ggplot()
png_model_grad
...
ggsave(
  suppfig7,
  filename = "output/figures/chapter_figs/suppfig7_model_gradients_placeholder.jpg",
  width = 6,
  height = 3,
  units = "in",
  dpi = 300
...
```{r suppfig8_alt_gradient_DS085, fig.width=6, fig.height=3.5, fig.retina=1}
# Specify labels/order
proteins_suppfig8_alt <- c("pCD79a (Y182)", "pSYK (Y525/Y526)", "pPLCy2 (Y759)")

# Select data for input plots
medians_combi_suppfig8AC <- medians_combi %>%
  subset(stim_description != "PBS step (0 mM)" & stim_description != "60 min quadratic gradient (10 mM)") %>%
  select(expID, stim_profile, gradient_duration, stim_description, stim_descrip_short, time_min, conc_at_time_mM) %>%
  distinct() %>%
  add_row(expID =  "DS097", stim_profile = "step", stim_description = "H2O2 step (2.5 mM)", stim_descrip_short = "step to 2.5 mM", time_min = 0, conc_at_time_mM = 2.5) %>%
...
# Panel A: DS085 - Input patterns
suppfig8_alt_panelA <- ggplot(subset(medians_combi_suppfig8AC, expID == "DS085")) +
  geom_vline(xintercept = 20, size = 0.5, linetype = "dashed") +
  geom_vline(xintercept = 60, size = 0.5, linetype = "dotdash") +
  geom_line(aes(x = time_min, y = conc_at_time_mM, group = stim_descrip_short, color = stim_description), size = 0.75) +
  facet_wrap(vars(factor(expID, labels = c("5 mM")))) + 
  scale_x_continuous(
    limits = c(0, 60),
    breaks = c(0, 20, 60),
  ) +
  scale_x_continuous(breaks = c(0, 20, 60), labels = c("0\n ", "20\n ", "60\n ")) +
  scale_y_continuous(breaks = c(0, 1.25, 2.5, 3.75, 5), labels = c("0", "1.25", "2.5", "3.75", "5")) + 
  scale_color_manual(
    values = c("H2O2 step (5 mM)" = "black", 
               "20 min gradient (5 mM)" = "#ff7f00", 
               "60 min gradient (5 mM)" = "#984ea3"),
    labels = c("", "", ""), 
    name = "",
  ) +
  labs(x = "Time (min)", y = expression("H"[2]*"O"[2]*" dose (mM)")) + 
  ...
  theme(panel.grid.minor = element_blank(), panel.grid.major.x = element_blank(), legend.position = "bottom", legend.justification = "left", legend.margin = margin(b = 0, t = -0.4, unit = "cm"), strip.text.x = element_text(margin = margin(0.1, 0, 0.1, 0, "cm")))
# suppfig8_alt_panelA

# Panel B: DS085 - Line plots of % ON vs conc
suppfig8_alt_panelB <- ggplot(subset(combi_conc_EC50, expID == "DS085" & protein != "cCaspase 3 + cPARP"),
       aes(
  ...
  geom_hline(yintercept = 50, size = 0.5, linetype = "dashed") +
  facet_wrap(vars(factor(protein, levels = proteins_suppfig8_alt)), ncol = 3) + 
  scale_color_manual(
  ...
  theme_bw() +
  textsize_small +
  theme(legend.position = "bottom", legend.justification = "left", panel.grid.minor = element_blank(), legend.margin = margin(b = 0, t = -0.4, unit = "cm"), axis.text.x = element_text(size = 6), strip.text.x = element_text(margin = margin(0.1, 0, 0.1, 0, "cm")), panel.spacing.x = unit(0.35, "cm"))
# suppfig8_alt_panelB

# Panel C: DS097 - Input patterns
suppfig8_alt_panelC <- ggplot(subset(medians_combi_suppfig8AC, expID == "DS097")) +
  geom_vline(xintercept = 20, size = 0.5, linetype = "dashed") +
  geom_vline(xintercept = 60, size = 0.5, linetype = "dotdash") +
  geom_line(aes(x = time_min, y = conc_at_time_mM, group = stim_descrip_short, color = stim_description), size = 0.75) +
  facet_wrap(vars(factor(expID, labels = c("2.5 mM + 5 mM")))) + 
  scale_x_continuous(
    limits = c(0, 60),
    breaks = c(0, 20, 60),
  ) +
  ...
  scale_y_continuous(breaks = c(0, 1.25, 2.5, 3.75, 5), labels = c("0", "1.25", "2.5", "3.75", "5")) + 
  scale_color_manual(
    values = c("H2O2 step (2.5 mM)" = "black", "H2O2 step (5 mM)" = "black", 
               "20 min gradient (5 mM)" = "#ff7f00", 
               "60 min gradient (2.5 mM)" = "#377eb8", "60 min gradient (5 mM)" = "#984ea3"),
    labels = c("", "", "", "", ""), 
    name = "",
  ) +
  labs(x = "Time (min)", y = expression("H"[2]*"O"[2]*" dose (mM)")) + 
...
# Panel D: DS097 - Line plots of % ON vs conc
suppfig8_alt_panelD <- ggplot(subset(combi_conc_EC50, expID == "DS097" & protein != "cCaspase 3 + cPARP"),
       aes(
         x = conc_at_time_mM_approx,
         y = percent_on, 
         group = stim_descrip_short,
...
# Combine all panels of the figure
suppfig8_alt <- plot_grid(suppfig8_alt_panelA, suppfig8_alt_panelB, suppfig8_alt_panelC, suppfig8_alt_panelD, labels = PANEL_labels[1:4], ncol = 2, rel_heights = c(1, 1), rel_widths = c(1, 2.5), label_size = 10)
...
ggsave(
  suppfig8_alt,
  filename = "output/figures/chapter_figs/suppfig8_alt_gradients.pdf",
  width = 6,
  height = 3.5,
  units = "in",
  dpi = 300
...
ggsave(
  suppfig8_alt,
  filename = "output/figures/chapter_figs/suppfig8_alt_gradients.jpg",
  width = 6,
  height = 3.5,
  units = "in",
  dpi = 300
...
ggsave(
  suppfig8_alt,
  filename = "output/figures/chapter_figs/suppfig8_alt_gradients.png",
  width = 6,
  height = 3.5,
  units = "in",
  dpi = 300
...
```
***Figure S8_alt: Gradient data used for determining the EC50% values** *


### Suppl fig S9

```{r supp_fig9_gating, fig.width=6, fig.height=2, fig.retina=1}
# Load panels
# suppfig10_panelA <- image_read("output/figures/gating_figs/gating_DS095-2.png") %>%
#   image_ggplot()
# # suppfig11_panelA

suppfig9_panelB <- image_read("output/figures/gating_figs/fig_debris_DS095.png") %>%
  image_ggplot()
# suppfig11_panelB

suppfig9_panelC <- image_read("output/figures/gating_figs/fig_singlets_DS095.png") %>%
  image_ggplot()
# suppfig11_panelC

suppfig9_panelD <- image_read("output/figures/gating_figs/fig_live_DS095.png") %>%
  image_ggplot()
# suppfig11_panelD

# Combine all panels of the figure
suppfig9 <- plot_grid(suppfig9_panelB, suppfig9_panelC, suppfig9_panelD, labels = PANEL_labels[1:3], ncol = 3, rel_widths = c(1, 1, 1), label_size = 10)
...
ggsave(
  suppfig9,
  filename = "output/figures/chapter_figs/suppfig9_gating.pdf",
  width = 6,
  height = 2,
  units = "in",
  dpi = 300
...
ggsave(
  suppfig9,
  filename = "output/figures/chapter_figs/suppfig9_gating.jpg",
  width = 6,
  height = 2,
  units = "in",
  dpi = 300
...
ggsave(
  suppfig9,
  filename = "output/figures/chapter_figs/suppfig9_gating.png",
  width = 6,
  height = 2,
  units = "in",
  dpi = 300
