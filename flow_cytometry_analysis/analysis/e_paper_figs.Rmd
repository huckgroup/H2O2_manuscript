...
textsize_abstract <- theme(text = element_text(size = 5, family = "sans", colour = "black"), 
                           plot.title = element_text(size = 5, family = "sans", colour = "black"))
```

```{r abstract_BCR, fig.retina=1}
...
```{r abstract_input, fig.retina=1}
# Select data
data_abstract_input <- medians_DS096 %>%
  select(stim_description, time_min, conc_at_time_mM) %>%
  distinct() %>%
  add_row(stim_description = "H2O2 step (10 mM)", time_min = 0, conc_at_time_mM = 10)

# Figure
abstract_input <- ggplot(data_abstract_input) +
  geom_vline(xintercept = 20, size = 0.25, linetype = "dashed") +
  geom_vline(xintercept = 60, size = 0.25, linetype = "dotdash") +
  geom_line(aes(x = time_min, y = conc_at_time_mM, group = stim_description, color = stim_description), linewidth = 0.7) +
  geom_text(aes(75, 10), label = expression("H"[2]*"O"[2]*" step"), color = "#4daf4a", size = 1.3, show.legend = F, hjust = 1, vjust = -0.5) +
  geom_text(aes(75, 0), label = "PBS step", color = "#377eb8", size = 1.3, show.legend = F, hjust = 1, vjust = -0.8) +
  geom_text(aes(20, 10), label = "20 min", color = "#ff7f00", size = 1.3, show.legend = F, hjust = 1.4, vjust = 1.6) +
  geom_text(aes(60, 10), label = "60 min linear", color = "#984ea3", size = 1.3, show.legend = F, hjust = 1.5, vjust = 1.6) +
  geom_text(aes(60, 10), label = "60 min\nexponential", color = "#cab2d6", size = 1.3, show.legend = F, hjust = -0.08, vjust = 1.2) +
  scale_x_continuous(
    limits = c(0, 75),
    breaks = c(0, 20, 60),
  ) +
  ...
  labs(x = "Time (min)", y = expression("H"[2]*"O"[2]*" dose (mM)"), title = "Input: Dynamic stimulus patterns") + 
  theme_bw() +
  textsize_abstract +
  theme(panel.grid = element_blank(), legend.position = "none", plot.margin = unit(c(0.1, 0.1, 0.1, 0.1), "cm"), axis.ticks = element_line(linewidth = 0.2)) # margins: t, r, b, l
# abstract_input

# Save figure as png
ggsave(
  abstract_input,
  filename = "output/figures/graphical_abstract_input.png",
  width = 1.75,
  height = 1,
  units = "in",
  dpi = 600
...
```{r abstract_output, fig.retina=1}
# Select data
data_abstract_output <- medians_DS096 %>%
  subset(protein == "pPLCy2 (Y759)" & staining == "yes" & stim_profile == "gradient")

# Figure
abstract_output <- ggplot(data_abstract_output,
                          aes(x = conc_at_time_mM,
                              y = percent_on, 
                              group = stim_description,
                              color = stim_description)) +
  geom_line(linewidth = 0.7) +
  geom_point(size = 0.8) +
  geom_hline(yintercept = 50, size = 0.25, linetype = "dashed") +
  scale_color_manual(values = colors_profiles) +
  coord_cartesian(ylim = c(0, 100)) +
  labs(x = expression("H"[2]*"O"[2]*" dose (mM)"), y = "% cells ON", title = "Output: Rate-dependent signaling response") +
  theme_bw() +
  textsize_abstract + 
  theme(legend.position = "none", panel.grid = element_blank(), plot.margin = unit(c(0.1, 0.1, 0.1, 0.1), "cm"), axis.ticks = element_line(linewidth = 0.2)) # margins: t, r, b, l
# abstract_output

# Save figure as png
ggsave(
  abstract_output,
  filename = "output/figures/graphical_abstract_output.png",
  width = 1.75,
  height = 1,
  units = "in",
  dpi = 600
...
```{r abstract_combi, fig.width=3.2, fig.height=2, fig.retina=1}
abstract_data <- plot_grid(abstract_input, abstract_output, ncol = 1, rel_heights = c(1, 1))
graphical_abstract <- plot_grid(png_BCR_network, abstract_data, ncol = 2, rel_widths = c(1, 1.25)) +
...
ggsave(
  graphical_abstract,
  filename = "output/figures/graphical_abstract.png",
  width = 3.2,
  height = 2,
  units = "in",
  dpi = 600
...
ggsave(
  fig1,
  filename = "output/figures/fig1_main.jpg",
  width = 6,
  height = 3,
  units = "in",
  dpi = 300
...
ggsave(
  fig1,
  filename = "output/figures/fig1_main.png",
  width = 6,
  height = 3,
  units = "in",
  dpi = 300
...
fig2_alt_panelA_big <- fig2_alt_panelA_full +
  textsize +
  inset_element(png_table, left = 0.01, bottom = 0.7, right = 0.54, top = 0.99)
  # inset_element(png_legend, left = 0.01, bottom = 0.74, right = 0.35, top = 0.99)
# Save figure as jpeg
ggsave(
  fig2_alt_panelA_big,
  filename = "output/figures/fig2_alt_panelA.jpeg",
  width = 5,
  height = 3.5,
  units = "in",
  dpi = 300
...
ggsave(
  fig2,
  filename = "output/figures/fig2_main.jpg",
  width = 6,
  height = 4.5,
  units = "in",
  dpi = 300
...
ggsave(
  fig2,
  filename = "output/figures/fig2_main.png",
  width = 6,
  height = 4.5,
  units = "in",
  dpi = 300
...
ggsave(
  fig3,
  filename = "output/figures/fig3_main.jpg",
  width = 6,
  height = 4.5,
  units = "in",
  dpi = 300
...
ggsave(
  fig3,
  filename = "output/figures/fig3_main.png",
  width = 6,
  height = 4.5,
  units = "in",
  dpi = 300
...
fig4_panelB_single <- ggplot(subset(medians_combi_fig4B, expID == "DS085")) +
  ...
  theme_bw() +
  textsize_small +
  theme(panel.grid.minor = element_blank(), panel.grid.major.x = element_blank(), legend.position = "none", legend.justification = "right")
# fig4_panelB_single
```
...
fig4_panelD_sens <- ggplot(data_fig4_sens) +
  ...
  theme_bw() +
  textsize_small +
  theme(legend.position = "none", panel.grid.minor = element_blank(), panel.grid.major.x = element_blank(), axis.title.y = element_text(size = 7))
# fig4_panelD_sens
```

```{r fig4_panelD_alt1, fig.retina=1, eval=F}
fig4_panelD_table <- ggplot() +
  geom_blank() +
  scale_x_continuous(limits = c(0, 10)) + 
  scale_y_continuous(limits = c(0, 10)) + 
  # labs(title = " ") + 
...
```{r fig4_panelD_alt2, fig.retina=1, eval=F}
...
```{r fig4_main, fig.width=5, fig.height=4.5, fig.retina=1}
# # Fig option 1
...
# ggsave(
#   fig4_v1,
#   filename = "output/figures/fig4_options/fig4_main_v1.jpg",
#   width = 6,
#   height = 2,
#   units = "in",
#   dpi = 300
...
# ggsave(
#   fig4_v2,
#   filename = "output/figures/fig4_options/fig4_main_v2.jpg",
#   width = 5.5,
#   height = 4,
#   units = "in",
#   dpi = 300
...
# 
# # Fig option 3
# fig4_AC <- plot_grid(png_rate_EC50, fig4_panelD_sens, labels = panel_labels[c(1, 3)], ncol = 1, rel_heights = c(2, 1), label_size = 10)
...
# ggsave(
#   fig4_v3,
#   filename = "output/figures/fig4_options/fig4_main_v3.jpg",
#   width = 6.5,
#   height = 5,
#   units = "in",
#   dpi = 300
...
# 
# # Fig option 4
# fig4_AD <- plot_grid(png_rate_EC50, fig4_panelD_sens, labels = panel_labels[c(1, 4)], ncol = 1, rel_heights = c(2, 1), label_size = 10)
# fig4_BC <- plot_grid(fig4_panelB_single, NULL, labels = c(panel_labels[2:3]), ncol = 1, rel_heights = c(1, 1), label_size = 10)
# fig4_v4 <- plot_grid(fig4_AD, fig4_BC, ncol = 2, rel_widths = c(1.2, 1), label_size = 10)
# 
# fig4_v4
# 
# ggsave(
#   fig4_v4,
#   filename = "output/figures/fig4_options/fig4_main_v4.jpg",
#   width = 6.5,
#   height = 5,
#   units = "in",
#   dpi = 300
...
# 
# # Fig option 5
# fig4_A <- plot_grid(png_rate_EC50, labels = c(panel_labels[1]), ncol = 1, label_size = 10)
# # fig4_A <- plot_grid(png_rate_EC50, NULL, labels = c(panel_labels[1], NULL), ncol = 2, rel_widths = c(2, 1), label_size = 10)
# fig4_BCD <- plot_grid(fig4_panelB_single, NULL, fig4_panelD_sens, labels = c(panel_labels[2:4]), ncol = 3, rel_widths = c(1, 1, 1), label_size = 10)
# fig4_v5 <- plot_grid(fig4_A, fig4_BCD, ncol = 1, rel_heights = c(2, 1), label_size = 10)
# 
# fig4_v5
# 
# ggsave(
#   fig4_v5,
#   filename = "output/figures/fig4_options/fig4_main_v5.jpg",
#   width = 6.5,
#   height = 5,
#   units = "in",
#   dpi = 300
...
# Fig option 6
fig4_AD <- plot_grid(png_rate_EC50, fig4_panelD_sens, labels = panel_labels[c(1, 4)], ncol = 2, rel_widths = c(1.65, 1), label_size = 10)
fig4_BC <- plot_grid(fig4_panelB_single, NULL, labels = c(panel_labels[2:3]), ncol = 2, rel_widths = c(1, 1), label_size = 10)
...
ggsave(
  fig4_v6,
  filename = "output/figures/fig4_options/fig4_main_v6.jpg",
  width = 5,
  height = 4.5,
  units = "in",
  dpi = 300
...
ggsave(
  fig4_v6,
  filename = "output/figures/fig4_main.jpg",
  width = 5,
  height = 4.5,
  units = "in",
  dpi = 300
...
ggsave(
  fig4_v6,
  filename = "output/figures/fig4_main.png",
  width = 5,
  height = 4.5,
  units = "in",
  dpi = 300
...
ggsave(
  suppfig1,
  filename = "output/figures/suppfig1_ridge_step.jpg",
  width = 6,
  height = 5,
  units = "in",
  dpi = 300
...
ggsave(
  suppfig1,
  filename = "output/figures/suppfig1_ridge_step.png",
  width = 6,
  height = 5,
  units = "in",
  dpi = 300
...
ggsave(
  suppfig2,
  filename = "output/figures/suppfig2_data_variability_placeholder.jpg",
  width = 4,
  height = 4,
  units = "in",
  dpi = 300
...
```{r supp_fig3_model_variability, fig.retina=1}
suppfig3 <- ggplot() +
  geom_blank() +
  scale_x_continuous(limits = c(0, 10)) + 
  scale_y_continuous(limits = c(0, 10)) + 
...
ggsave(
  suppfig3,
  filename = "output/figures/suppfig3_model_variability_placeholder.jpg",
  width = 6,
  height = 3,
  units = "in",
  dpi = 300
...
```{r supp_fig4_model_DR,fig.width=3, fig.height=2.5, fig.retina=1}
...
ggsave(
  suppfig4_place,
  filename = "output/figures/suppfig4_model_DR_placeholder.jpg",
  width = 3,
  height = 2.5,
  units = "in",
  dpi = 300
...
ggsave(
  suppfig5,
  filename = "output/figures/suppfig5_ridge_gradient.jpg",
  width = 6,
  height = 6,
  units = "in",
  dpi = 300
...
ggsave(
  suppfig5,
  filename = "output/figures/suppfig5_ridge_gradient.png",
  width = 6,
  height = 6,
  units = "in",
  dpi = 300
...
ggsave(
  suppfig6,
  filename = "output/figures/suppfig6_line_gradient.jpg",
  width = 6,
  height = 6,
  units = "in",
  dpi = 300
...
ggsave(
  suppfig6,
  filename = "output/figures/suppfig6_line_gradient.png",
  width = 6,
  height = 6,
  units = "in",
  dpi = 300
...
ggsave(
  suppfig7,
  filename = "output/figures/suppfig7_model_gradients_placeholder.jpg",
  width = 6,
  height = 3,
  units = "in",
  dpi = 300
...
```{r suppfig8_gradient_DS085, fig.width=6, fig.height=7, fig.retina=1, eval=F}
# Load data
# DS085: LinGradient_Conc
data_DS085 <- read_csv("output/annotated_data/annotated_data_tidy_DS085.csv") %>%
  subset(staining == "yes") %>%
...
ggsave(
  suppfig8,
  filename = "output/figures/suppfig8_gradient_DS085.jpg",
  width = 6,
  height = 7,
  units = "in",
  dpi = 300
...
ggsave(
  suppfig8,
  filename = "output/figures/suppfig8_gradient_DS085.png",
  width = 6,
  height = 7,
  units = "in",
  dpi = 300
...
```{r suppfig9_gradient_DS097, fig.width=6, fig.height=7, fig.retina=1, eval=F}
# Load data
# DS097: LinGradient_LowConc
data_DS097 <- read_csv("output/annotated_data/annotated_data_tidy_DS097.csv") %>%
  subset(staining == "yes") %>%
...
ggsave(
  suppfig9,
  filename = "output/figures/suppfig9_gradient_DS097.jpg",
  width = 6,
  height = 7,
  units = "in",
  dpi = 300
...
ggsave(
  suppfig9,
  filename = "output/figures/suppfig9_gradient_DS097.png",
  width = 6,
  height = 7,
  units = "in",
  dpi = 300
...
```{r suppfig8_alt_gradient_DS085, fig.width=6.5, fig.height=4, fig.retina=1}
...
suppfig8_alt_panelA <- ggplot(subset(medians_combi_suppfig8AC, expID == "DS085")) +
  ...
  theme(panel.grid.minor = element_blank(), panel.grid.major.x = element_blank(), legend.position = "bottom", legend.justification = "left", legend.margin = margin(b = 0, t = -0.4, unit = "cm"))
# suppfig8_alt_panelA
...
suppfig8_alt_panelB <- ggplot(subset(combi_conc_EC50, expID == "DS085" & protein != "cCaspase 3 + cPARP"),
  ...
  theme_bw() +
  textsize_small +
  theme(legend.position = "bottom", legend.justification = "left", panel.grid.minor = element_blank(), legend.margin = margin(b = 0, t = -0.4, unit = "cm"), axis.text.x = element_text(size = 5.5))
# suppfig8_alt_panelB
...
# Combine all panels of the figure
suppfig8_alt <- plot_grid(suppfig8_alt_panelA, suppfig8_alt_panelB, suppfig8_alt_panelC, suppfig8_alt_panelD, labels = panel_labels[1:4], ncol = 2, rel_heights = c(1, 1), rel_widths = c(1, 3), label_size = 10)
...
ggsave(
  suppfig8_alt,
  filename = "output/figures/suppfig8_alt_gradients.pdf",
  width = 6.5,
  height = 4,
  units = "in",
  dpi = 300
...
ggsave(
  suppfig8_alt,
  filename = "output/figures/suppfig8_alt_gradients.jpg",
  width = 6.5,
  height = 4,
  units = "in",
  dpi = 300
...
ggsave(
  suppfig8_alt,
  filename = "output/figures/suppfig8_alt_gradients.png",
  width = 6.5,
  height = 4,
  units = "in",
  dpi = 300
...
ggsave(
  suppfig10,
  filename = "output/figures/suppfig10_gating.jpg",
  width = 6,
  height = 2,
  units = "in",
  dpi = 300
...
ggsave(
  suppfig10,
  filename = "output/figures/suppfig10_gating.png",
  width = 6,
  height = 2,
  units = "in",
  dpi = 300
