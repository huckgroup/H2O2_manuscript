...
fig2_AB <- plot_grid(fig2_panelA_full, png_DR_vis, labels = panel_labels[1:2], ncol = 2, rel_widths = c(1.2, 1), label_size = 10)
fig2_CD <- plot_grid(png_model, png_model_percent, labels = panel_labels[3:4], ncol = 2, rel_widths = c(1, 1.2), label_size = 10)
...
ggsave(
  suppfig3,
  filename = "output/figures/suppfig3_model_variability_placeholder.jpeg",
  width = 6,
  height = 3,
  units = "in",
  dpi = 300
...
ggsave(
  suppfig4_place,
  filename = "output/figures/suppfig4_model_DR_placeholder.jpeg",
  width = 3,
  height = 2.5,
  units = "in",
  dpi = 300
