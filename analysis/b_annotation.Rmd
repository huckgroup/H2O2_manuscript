...
Save annotated datasets as .csv file
```{r save_Bas013}
write.csv(df_tidy_Bas013, file = "output/annotated_data/annotated_data_tidy_Bas013.csv", row.names = F)

write.csv(medians_tidy_Bas013, file = "output/annotated_data/annotated_medians_tidy_Bas013.csv", row.names = F)
...
Save annotated datasets as .csv file
```{r save_DS098}
write.csv(df_tidy_DS098, file = "output/annotated_data/annotated_data_tidy_DS098.csv", row.names = F)

write.csv(medians_tidy_DS098, file = "output/annotated_data/annotated_medians_tidy_DS098.csv", row.names = F)

write.csv(medians_avg_DS098, file = "output/annotated_data/annotated_medians_avg_rep_DS098.csv", row.names = F)
