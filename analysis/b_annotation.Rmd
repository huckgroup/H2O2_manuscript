...
```{r tidy_DS095, eval=F}
# Combine all data into one tidy dataframe (all data in one column instead of one column for each fluor)
cols_meta_DS095 <- c("expID", "plateID", "wellID", "sample", "stimulus", "stim_profile", "gradient_duration", "stim_description", "time_min", "time_point", "conc_at_time_mM", "cumulative_exposure", "staining", "panel", "sample_cell_count") # include all metadata columns
