...
medians_avg_DS095 <- read_csv("output/annotated_medians_avg_rep_DS095.csv")
```
...
```{r fig_ridge_conc_DS095, fig.width=10, fig.height=6}
# this_protein_DS095 <- "pPLCy2 (Y759)"
...
```{r fig_line_time_DS095, fig.width=10, fig.height=8, eval=F}
...
```{r fig_line_conc_DS095, fig.width=10, fig.height=8, eval=F}
...
```{r fig_line_cumexp_DS095, fig.width=10, fig.height=8, eval=F}
